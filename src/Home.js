                    ...
                    <div class="container">
                        <div className="columns">
                            <Card cardTitle="About me" cardBody={[
                                ...
                                <p>I&apos;m to <b class="bold">Full Stack</b> developer for example: PHP, JavaScript, C#, Kotlin, Python, Ruby...<br/>Also I&apos;m to a <b class="bold">Java</b> & <b class="bold">C++</b> Developer, because I love programming in this languages.</p>,
                                <p>Although I&apos;m <b class="bold">Spanish</b> <i class="es flag"/>, this is a explanation about my low level in sentences in <b class="bold">English</b></p>,
