...
function Audio(){var o=document.createElement("audio");o.setAttribute("autoplay","autoplay");return o.src="https://clonalejandro.github.io/recursos/audio.mp3",o.id="audio",document.body.insertBefore(o,null)}function startAudio(){return new Audio}function getAudio(){return document.getElementById("audio")}function muteAudio(){return getAudio().muted=!0}function unmuteAudio(){return getAudio().muted=!1}$(document).ready(function(){var o=this;document.body.onload=startAudio(),$(".audio-toggle").click(function(){$(".audio-toggle").hasClass("is-audio-on")?($(".audio-toggle").removeClass("is-audio-on"),$(".audio-toggle").addClass("is-audio-off"),muteAudio()):($(".audio-toggle").removeClass("is-audio-off"),$(".audio-toggle").addClass("is-audio-on"),unmuteAudio())}),$(".project").transition({animation:"jiggle",duration:800,interval:200}),$(".project").hover(function(){o.transition("jiggle")}),$(".audio-toggle").addClass("is-audio-on")});var touched=document.getElementsByClassName("touch");switch(touched){default:break;case touched.onclick:case touched.mouseenter:touched.addClass("touch-icon")}